/* packet-grypiaura.h
 * Definitions for grypiaura packet disassembly structures and routines
 * By Steve Limkemann <stevelim@dgtech.com>
 * Copyright 1998 Steve Limkemann
 *
 * $Id: packet-grypiaura.h,v 1.1 2015/04/15 03:33:25 bhagavan Exp $
 *
...
#define SD_IOPWR                0x27    /* VNG / Compact grypiaura I/O & power */
...
#define CMD_PGM_UPLOAD	    	(SD_PGM * 256 + 0x91)	/* Upload a program to the grypiaura */
